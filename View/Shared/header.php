...
<!--	<link href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/Content/css/bootstrap.css" rel="stylesheet" />
	...
	<link href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/Content/css/reset.css" rel="stylesheet" type="text/css" />
                ...
                <!-- Include all compiled plugins (below), or include individual files as needed -->
                    <script src="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/Content/js/bootstrap.min.js"></script>
        ...
        <nav class="navbar navbar-default">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/View/Public/index.php">
                                    <img id="logo" src="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/Content/uploads/images/logo.jpg" alt="gotorecipes" /></a>
                        </div><!-- end of "navbar-header-->

                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                <li><a href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/View/Admin/register.php">Register</a></li>
                                <li><a href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/View/Admin/login.php">Login</a></li>
                                ...
                                <li class="active"><a href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/View/Public/index.php">Home<span class="sr-only">(current)</span></a></li>
                                ...
                                <li><a href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/View/Public/ImageGallery/imagegallery.php">Gallery</a></li>
                                <li><a href="#">Events</a></li>
                                <li><a href="<?php $_SERVER["DOCUMENT_ROOT"]; ?>/GotorecipesGITHUB/GotoReicpes2015/View/Public/ContactUs/contactus_form.php">Contact Us</a></li>
                                </ul>
